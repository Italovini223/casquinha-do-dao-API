...
describe('OrderService', () => {
  ...
  const orderData = {
    userId: "673a24e87ffd12298470045b",
    products: [
      { id: 'test-product-id-1', orderId: 'test-order-id', productId: 'test-product-id-1', quantity: 2, price: 10 },
      { id: 'test-product-id-2', orderId: 'test-order-id', productId: 'test-product-id-2', quantity: 3, price: 20 }
    ],
    total: 100
  };
